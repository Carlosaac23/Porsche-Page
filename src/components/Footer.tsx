		...
		<footer>
			<div className='mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8'>
				...
				<div className='mt-8 md:order-1 md:mt-0'>
					<div className='flex justify-center space-x-6 text-neutral-500 text-sm md:justify-start'>
					...
					<p className='mt-4 text-center text-neutral-400 text-xs md:text-left'>
