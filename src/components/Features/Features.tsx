  ...
  return (
    <section className='my-30'>
      ...
      <div className='relative'>
        ...
        <div className='absolute -top-8 -left-4 xl:left-16 2xl:-left-14 3xl:left-24 rounded-lg p-3 2xl:p-5 bg-neutral-500/10 backdrop-blur-xs text-center 2xl:text-left'>
        ...
        <div className='absolute -bottom-8 -right-4 xl:right-16 2xl:-right-16 3xl:right-26 rounded-lg p-3 2xl:p-5 bg-neutral-500/10 backdrop-blur-xs text-center 2xl:text-right'>
          <h3 className='font-semibold 2xl:text-2xl'>
