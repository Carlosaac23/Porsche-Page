...
export default function Card({ brand, model, img, acceleration, topSpeed, fuelGas, price }) {
  return (
    <div
      className='flex flex-col items-center p-5 border border-neutral-800 rounded-lg hover:border-neutral-600 duration-200 ease-out cursor-pointer
    '
    >
      ...
      <ul className='flex justify-between gap-3 mb-2'>
      ...
      <p className='w-full text-left font-bold'>USD {price}</p>
    </div>
  );
}
