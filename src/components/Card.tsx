...
export default function Card(props: CardProps) {
	return (
		<div className='mb-16 flex max-w-2xs cursor-pointer flex-col items-center rounded-lg border border-neutral-800 p-5 text-center hover:border-neutral-500'>
			<h2 className='font-bold text-lg'>{props.brand}</h2>
			<h3 className='font-light text-neutral-400 text-xs'>{props.model}</h3>
			<img
			...
			<p className='font-bold text-sm'>USD {props.price}</p>
		</div>
	);
}
