...
export default function About() {
  return (
    <section className='3xl: my-30 justify-around gap-14 lg:flex' id='about'>
      <div className='relative mb-20 w-fit'>
        ...
        <div className='absolute -right-3 -bottom-5 rounded-lg bg-neutral-500/10 p-3 text-center backdrop-blur-sm lg:bottom-1 xl:-bottom-6'>
