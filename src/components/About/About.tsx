    ...
    <section className='my-30 md:flex justify-around gap-14' id='about'>
      <div className='relative w-fit mb-20'>
        <motion.img
          ...
          className='w-full 2xl:w-2xl h-auto object-cover rounded-lg'
          src='/interior.webp'
          alt='Interior Porsche Image'
        />
        ...
        <motion.div
          ...
          transition={{ duration: 1, ease: 'easeOut' }}
          className='absolute -right-3 -bottom-5 md:-right-6 md:-bottom-6 p-4 backdrop-blur-xs bg-neutral-500/10 rounded-lg text-center'
        >
          <h3 className='font-bold'>1110 Nm</h3>
          <p className='text-sm font-light'>Up to 1110 Nm</p>
        </motion.div>
      </div>
      <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 1, ease: 'easeOut' }} className='md:w-lg'>
        ...
        <a href='#' className='font-semibold text-sm border border-neutral-800 py-4 px-7 rounded-lg hover:border-neutral-600 duration-200 ease-out'>
          More information
        </a>
      </motion.div>
    </section>
